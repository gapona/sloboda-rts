...
import { createPershaSloboda } from './maps/pershaSloboda';
...
export function createStoryMap(id: StoryMapId, seed: number): StoryMapDefinition {
  switch (id) {
    case 'engine-demo':
      return createEngineDemo(seed);
    case 'persha-sloboda':
      return createPershaSloboda(seed);
    case 'custom-map':
      return createCustomMap(seed);
  }
}

function createEngineDemo(seed: number): StoryMapDefinition {
